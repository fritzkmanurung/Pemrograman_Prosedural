...
int main(int _argc, char **_argv)
{
    ...
    assign_student(&students[0], &dorms[1]);
    assign_student(&students[1], &dorms[1]);
    assign_student(&students[2], &dorms[1]);
    assign_student(&students[3], &dorms[1]);
    assign_student(&students[4], &dorms[0]);
    assign_student(&students[5], &dorms[0]);
    assign_student(&students[6], &dorms[1]);
    assign_student(&students[7], &dorms[1]);
    assign_student(&students[8], &dorms[1]);
    assign_student(&students[9], &dorms[1]);
